...
if __name__ == '__main__':
    ...
    output_columns = [
        ...
        'hostname',
        'esi_score',
        'pl_eqt', # The official equilibrium temperature from the API
        'eq_temp_k', # Your calculated temperature
        'pl_dens', # The official density from the API
        'density_si', # Your calculated density
    ...
    # Convert Kelvin to Celsius for interpretation
    ...
    if os.path.exists(esi_csv_path):
        try:
            ...
            # (Optional) Display the names of the common planets
